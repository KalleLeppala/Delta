...
# P1 -> P3
table <- tables[[1]]
event <- c(event, rep("P1 -> P3", 6))
statistic <- c(statistic, "DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0")
value <- c(value, DS1S8(table)[[1]], DS2S8(table)[[1]], DS3S7(table)[[1]], DS4S7(table)[[1]], DS7S9(table)[[1]], DS8S0(table)[[1]])
pvalue <- c(pvalue, DS1S8(table)[[2]], DS2S8(table)[[2]], DS3S7(table)[[2]], DS4S7(table)[[2]], DS7S9(table)[[2]], DS8S0(table)[[2]])
sign <- c(sign, DS1S8(table)[[3]], DS2S8(table)[[3]], DS3S7(table)[[3]], DS4S7(table)[[3]], DS7S9(table)[[3]], DS8S0(table)[[3]])
# P3 -> P1
table <- tables[[2]]
event <- c(event, rep("P3 -> P1", 6))
statistic <- c(statistic, "DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0")
value <- c(value, DS1S8(table)[[1]], DS2S8(table)[[1]], DS3S7(table)[[1]], DS4S7(table)[[1]], DS7S9(table)[[1]], DS8S0(table)[[1]])
pvalue <- c(pvalue, DS1S8(table)[[2]], DS2S8(table)[[2]], DS3S7(table)[[2]], DS4S7(table)[[2]], DS7S9(table)[[2]], DS8S0(table)[[2]])
sign <- c(sign, DS1S8(table)[[3]], DS2S8(table)[[3]], DS3S7(table)[[3]], DS4S7(table)[[3]], DS7S9(table)[[3]], DS8S0(table)[[3]])
...
UUSI1 <- new_symmetric[new_symmetric$statistic %in% c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"), ]
UUSI1 <- UUSI1[UUSI1$event %in% events, ]
UUSI1$statistic <- factor(UUSI1$statistic, levels <- c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"))
...
UUSI2 <- new_symmetric[new_symmetric$statistic %in% c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"), ]
UUSI2 <- UUSI2[UUSI2$event %in% events, ]
UUSI2$statistic <- factor(UUSI2$statistic, levels <- c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"))
UUSI2$event <- factor(UUSI2$event, levels <- events)
ggplot(UUSI2, aes(fill = statistic, y = value, x = event)) + 
	geom_bar(position = position_dodge(0.85), stat = "identity") +
  geom_text(position = position_dodge(0.85), aes(y = 0, label = sign, hjust = 0))
```
...
UUSI3 <- new_symmetric[new_symmetric$statistic %in% c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"), ]
UUSI3 <- UUSI3[UUSI3$event %in% events, ]
UUSI3$statistic <- factor(UUSI3$statistic, levels <- c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"))
UUSI3$event <- factor(UUSI3$event, levels <- events)
ggplot(UUSI3, aes(fill = statistic, y = value, x = event)) + 
	geom_bar(position = position_dodge(0.85), stat = "identity") +
  geom_text(position = position_dodge(0.85), aes(y = 0, label = sign, hjust = 0))
```
...
UUSI4 <- new_symmetric[new_symmetric$statistic %in% c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"), ]
UUSI4 <- UUSI4[UUSI4$event %in% events, ]
UUSI4$statistic <- factor(UUSI4$statistic, levels <- c("DS1S8", "DS2S8", "DS3S7", "DS4S7", "DS7S9", "DS8S0"))
UUSI4$event <- factor(UUSI4$event, levels <- events)
ggplot(UUSI4, aes(fill = statistic, y = value, x = event)) + 
	geom_bar(position = position_dodge(0.85), stat = "identity") +
  geom_text(position = position_dodge(0.85), aes(y = 0, label = sign, hjust = 0))
```
